...
import initPersonArr from "./DB/personListDb";

function App() {
  const localData = JSON.parse(localStorage.getItem("personArrNew"));
  const setLocalData = (arr) =>
    localStorage.setItem("personArrNew", JSON.stringify(arr));
